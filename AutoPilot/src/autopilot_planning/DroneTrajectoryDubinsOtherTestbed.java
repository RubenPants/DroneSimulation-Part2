...
public class DroneTrajectoryDubinsOtherTestbed extends DroneTrajectory {
	
	/*
	 * Reset does not always work!
	 * Sometimes the drone keeps wandering into the distance..
	 * 
	 * Error when trying to catch a cube mid-path (not target)
	 */
