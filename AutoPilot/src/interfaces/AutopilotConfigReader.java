...
/**
 * A class of autopilot configuration readers, to read autopilot configurations
 * from a stream.
 */
public class AutopilotConfigReader {
	...
	/**
	 * Read bytes from an input stream and convert them to an autopilot
	 * configuration.
	 * 
	 * @param stream
	 *            The input stream to read from.
	 * @return An autopilot configuration having values corresponding to the given
	 *         input stream.
	 * @throws IOException
	 *             If an I/O error occurs.
	 */
