...
public interface AutopilotConfig {
	...
	/**
	 * Return the distance between the drone's center of gravity and the point where
	 * the wings' mass and lift are located.
	 */
	float getWingX();

	/**
	 * Return the distance between the drone's center of gravity and the point where
	 * the tail mass and the lift generated by the horizontal and vertical
	 * stabilizers is located.
	 */
	float getTailSize();

	/**
	 * Return the mass of the engine. The engine is located in front of the drone's
	 * center of gravity.
	 */
	float getEngineMass();

	/**
	 * Return the mass of the left wing. Equals the mass of the right wing. Modeled
	 * as being located in a single point.
	 */
	float getWingMass();
	...
	/**
	 * Return the maximum magnitude of the angle of attack of all four airfoils. If
	 * during a simulation an airfoil's angle of attack exceeds this value, the
	 * simulator may report an error and abort the simulation.
	 */
	float getMaxAOA();
